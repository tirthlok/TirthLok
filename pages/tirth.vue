  ...
  <div class="min-h-screen bg-white py-4 sm:py-8 md:py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center py-16">
        <Icon name="Building2" :size="64" class="text-gray-300 mx-auto mb-4" />
        <h2 class="text-xl md:text-2xl font-semibold text-gray-900 mb-2">All Tirth</h2>
        <p class="text-gray-600">Complete list of Jain pilgrimage sites coming soon</p>
      </div>
    </div>
  </div>
</template>
