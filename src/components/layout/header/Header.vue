...
import TirthFilterPanel from '~/features/tirth/tirthpage/components/TirthFilterPanel.vue'
...
import { useBhojanshalaStore } from '~/features/bhojanshala/shared/composables/useBhojanshalaStore'
