  ...
  <div :class="[
    ...
    themeStore?.isDarkMode ? 'dark bg-gray-950' : 'bg-white'
      ...
      <div v-if="loading" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 pb-4">
        <DharamshalaCardSkeleton v-for="n in 8" :key="n" />
      </div>
...
import { useDharamshalaStore } from '~/features/dharamshala/shared/composables/useDharamshalaStore'
import { useWishlistStore } from '~/features/wishlist'
import { useAuth } from '~/features/auth/composables/useAuth'
import { Icon } from '~/components/ui'
import DharamshalaCardSkeleton from '~/features/dharamshala/dharamshalalistpage/components/DharamshalaCardSkeleton.vue'
import DharamshalaCard from '~/features/dharamshala/shared/components/DharamshalaCard.vue'
import DharamshalaFilterPanel from '~/features/dharamshala/dharamshalalistpage/components/DharamshalaFilterPanel.vue'
...
const { data: dharamshalaData, pending: loading, error: fetchError } = useFetch<Dharamshala[]>(
